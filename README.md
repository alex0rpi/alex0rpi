# Bon dia! My name is Alex Orpinell! 👋🏻

I am an engineer and a software developer.
...
* Jan-June 2023 | Backend development bootcamp at Mediatic (Barcelona). The program was aimed at NodeJS technologies including Typescript, MongoDB, MySQL, RestAPI with Express, Unit Testing and some programing patterns (Singleton, Factory Pattern etc.). The end of bootcamp project is a fullstrack chat web app that can be found in my pinned repositories.<br>
...
![YAML](https://img.shields.io/badge/YAML-FCC624?style=for-the-badge&logo=yaml&logoColor=white)
### Backend stack
...
![Koa](https://img.shields.io/badge/Koa.js-333333?style=for-the-badge&logo=node.js&logoColor=white)

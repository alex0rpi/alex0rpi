...
* November 2024 A new project starts within my company and I now find myself learning JAVA! Seems I need to get competent at the Spring framework for this new project. Incidently, the basic knowledge I gained from C# and Go i being helpful to grasp and interiorize the JAVA syntax. On the other hand it looks like NextJS is gonna have to wait a bit.

...
* June 2024 🕓📅 It's been 6 months already at NTT DATA and in this journey I'd summarize my activities as follows:
  * I'm using a JS fullstack framework called Hyperfront, developed by the french firm Basikon. It basically eliminates the classic separation between backend and frontend. It uses React under the hood and a number of custom functions for making API requests.
  * Use of mongoDB. I've been using some advance query features like pipelines, aggregates and projections.
  * Use of JEST for Unit tests. This implies the use of a lean architecture for functions and scripts so each one is as simple as it can be and with a single responsability.
  * I definetly leveled up my Git skills in the last months. I feel confident managing stashes, merges, rebases and conflicts.
  * Reporting to a french client (so refreshing my french skills) and applying Poker planning. 
